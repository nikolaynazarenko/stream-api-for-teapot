...
import stream.exception.EntityNotFoundException;
import stream.exception.ExerciseNotCompletedException;
...
public class CrazyStreams {
     ...
     * @return map of account by its ids they were created in a particular year
     */
